    ...
    <PageContent padding="large">
      ...
      >
        <template #default="{ hasError, hasChanged }">
          ...
          <div
            class="sticky h-fit top-4 grid gap-6 place-items-center max-xl:hidden"
          >
            <Card padding>
              <Text typo="title7">
                {{ $t("pages.edit-quote.total-global") }}
              ...
              <div
                class="grid grid-cols-[min-content_1fr] gap-2 items-center mt-4"
              >
                <Text typo="title7">
                  {{ $t("pages.edit-quote.without-taxes") }}
                </Text>
