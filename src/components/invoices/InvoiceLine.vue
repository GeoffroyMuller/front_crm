<template>
  <div v-if="line.type === 'comment'">
    <TextField
      multiline
      :label="$t('pages.edit-invoice.comment')"
      name="description"
    />
  </div>
  <div v-if="line.type === 'title'">
    <TextField :label="$t('pages.edit-invoice.title')" name="description" />
  </div>
  <div v-if="line.type === 'product'" class="line-product-container">
    <MagicAutocomplete
      class="input"
      :label="$t('pages.edit-invoice.product')"
      :store="productsStore"
    ...
    <HtmlEditor
      class="description"
      :label="$t('pages.edit-invoice.description')"
    ...
    <div class="line-product">
      <TextField
        ...
        :label="$t('pages.edit-invoice.qty')"
        :step="1"
        name="qty"
      />
      <TextField
        ...
        :label="$t('pages.edit-invoice.unit_price')"
        name="unit_price"
      />
      ...
      <Select
        ...
        :label="$t('pages.edit-invoice.vat')"
        name="idVat"
      />
      ...
      <div class="total">
        <div class="inner">
          <div>
            <div class="label">
              {{ $t("pages.edit-invoice.total-without-taxes") }}
            </div>
            <div class="value">{{ totalWithoutTaxes }} €</div>
          </div>
          <div>
            <div class="label">{{ $t("pages.edit-invoice.total") }}</div>
